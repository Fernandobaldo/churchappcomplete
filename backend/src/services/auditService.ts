 ...
 */
export async function getMemberAuditLogs(memberId: string, limit = 50) {
  return getAuditLogs({
    entityType: 'Member',
    entityId: memberId,
    limit,
 ...
 */
export async function getBranchAuditLogs(branchId: string, limit = 50) {
  return getAuditLogs({
    entityType: 'Branch',
    entityId: branchId,
    limit,
 ...
 */
export async function getChurchAuditLogs(churchId: string, limit = 50) {
  return getAuditLogs({
    entityType: 'Church',
    entityId: churchId,
    limit,
